...
function sb_ajax_execute() {
    ...
    switch ($function) {
        ...
        case 'verification-cookie':
            ...
            return sb_json_response(sb_verification_cookie('auto', $_POST['domain']));
        case 'on-close':
...
function sb_json_response($result) {
    ...
    if (sb_is_error($result)) {
        ...
        return empty($GLOBALS['SB_JSON_RAW']) ? json_encode($response, JSON_INVALID_UTF8_IGNORE) : sb_api_success($result) ;
